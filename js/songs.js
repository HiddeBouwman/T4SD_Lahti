...
const songsDatabase = [
    {
        ...
        lyrics: [
            { finnish: "Kesäyö on kaunis ja tähdet loistaa", english: "Summer night is beautiful and stars shine", spanish: "La noche de verano es hermosa y las estrellas brillan", french: "La nuit d'été est belle et les étoiles brillent", arabic: "ليلة الصيف جميلة والنجوم تتلألأ", dutch: "Zomernacht is mooi en sterren schijnen", time: 0 },
            { finnish: "Kuljen metsäpolkuja rauhassa", english: "I walk forest paths peacefully", spanish: "Camino por senderos del bosque tranquilamente", french: "Je marche sur les sentiers forestiers paisiblement", arabic: "أمشي على مسارات الغابة بسلام", dutch: "Ik wandel rustig over bospaden", time: 6 },
            { finnish: "Kuuntelen lintujen laulua", english: "I listen to birds singing", spanish: "Escucho el canto de los pájaros", french: "J'écoute le chant des oiseaux", arabic: "أستمع إلى غناء الطيور", dutch: "Ik luister naar vogels zingen", time: 12 },
            { finnish: "Sydän täynnä iloa ja onnea", english: "Heart full of joy and happiness", spanish: "Corazón lleno de alegría y felicidad", french: "Cœur plein de joie et de bonheur", arabic: "قلب مليء بالفرح والسعادة", dutch: "Hart vol vreugde en geluk", time: 18 },
            { finnish: "Kuu paistaa kirkkaasti taivaalla", english: "Moon shines brightly in the sky", spanish: "La luna brilla intensamente en el cielo", french: "La lune brille vivement dans le ciel", arabic: "القمر يشرق بشدة في السماء", dutch: "Maan schijnt helder aan de hemel", time: 24 },
            { finnish: "Yö on hiljainen ja rauhallinen", english: "Night is quiet and peaceful", spanish: "La noche es tranquila y pacífica", french: "La nuit est calme et paisible", arabic: "الليل هادئ وسلمي", dutch: "Nacht is stil en vredig", time: 30 },
            { finnish: "Kuulen vain luonnon äänet", english: "I hear only nature's sounds", spanish: "Solo escucho los sonidos de la naturaleza", french: "J'entends seulement les sons de la nature", arabic: "أسمع فقط أصوات الطبيعة", dutch: "Ik hoor alleen geluiden van de natuur", time: 36 },
            { finnish: "Puut huojuvat hiljaa tuulessa", english: "Trees sway quietly in the wind", spanish: "Los árboles se mecen suavemente en el viento", french: "Les arbres se balancent doucement dans le vent", arabic: "الأشجار تتمايل بهدوء في الريح", dutch: "Bomen wiegen zachtjes in de wind", time: 42 },
            ...
            { finnish: "En halua että se loppuu", english: "I don't want it to end", spanish: "No quiero que termine", french: "Je ne veux pas que ça finisse", arabic: "لا أريد أن تنتهي", dutch: "Ik wil niet dat het eindigt", time: 54 },
            { finnish: "Luonto on täynnä elämää", english: "Nature is full of life", spanish: "La naturaleza está llena de vida", french: "La nature est pleine de vie", arabic: "الطبيعة مليئة بالحياة", dutch: "Natuur zit vol leven", time: 60 },
            { finnish: "Tunnen itseni niin vapaaksi", english: "I feel so free", spanish: "Me siento tan libre", french: "Je me sens si libre", arabic: "أشعر بحرية كبيرة", dutch: "Ik voel me zo vrij", time: 66 },
            { finnish: "Tuuli tuoksuu raikkaalta kesältä", english: "Wind smells like fresh summer", spanish: "El viento huele a verano fresco", french: "Le vent sent l'été frais", arabic: "الريح رائحتها كالصيف المنعش", dutch: "Wind ruikt naar frisse zomer", time: 72 },
            { finnish: "Ruoho on vihreää ja pehmeää", english: "Grass is green and soft", spanish: "La hierba es verde y suave", french: "L'herbe est verte et douce", arabic: "العشب أخضر وناعم", dutch: "Gras is groen en zacht", time: 78 },
            { finnish: "Olen onnellinen täällä", english: "I am happy here", spanish: "Soy feliz aquí", french: "Je suis heureux ici", arabic: "أنا سعيد هنا", dutch: "Ik ben hier gelukkig", time: 84 },
            { finnish: "Kesäyö on niin ihanaa", english: "Summer night is so wonderful", spanish: "La noche de verano es tan maravillosa", french: "La nuit d'été est si merveilleuse", arabic: "ليلة الصيف رائعة جداً", dutch: "Zomernacht is zo heerlijk", time: 90 },
            { finnish: "Tähdet tuikkivat kuin timantit", english: "Stars twinkle like diamonds", spanish: "Las estrellas titilan como diamantes", french: "Les étoiles scintillent comme des diamants", arabic: "النجوم تتلألأ مثل الألماس", dutch: "Sterren fonkelen als diamanten", time: 96 },
            { finnish: "Haluan muistaa tämän hetken", english: "I want to remember this moment", spanish: "Quiero recordar este momento", french: "Je veux me souvenir de ce moment", arabic: "أريد أن أتذكر هذه اللحظة", dutch: "Ik wil dit moment onthouden", time: 102 },
            { finnish: "Kesä tuo mukanaan iloa", english: "Summer brings joy with it", spanish: "El verano trae alegría consigo", french: "L'été apporte de la joie", arabic: "الصيف يجلب الفرح معه", dutch: "Zomer brengt vreugde met zich mee", time: 108 },
            { finnish: "Nautin jokaisesta hetkestä", english: "I enjoy every moment", spanish: "Disfruto cada momento", french: "Je profite de chaque moment", arabic: "أستمتع بكل لحظة", dutch: "Ik geniet van elk moment", time: 114 },
            { finnish: "Yö jatkuu kauniisti", english: "Night continues beautifully", spanish: "La noche continúa bellamente", french: "La nuit continue magnifiquement", arabic: "الليل يستمر بجمال", dutch: "Nacht gaat prachtig door", time: 120 },
            { finnish: "Olen kiitollinen tästä hetkestä", english: "I am grateful for this moment", spanish: "Estoy agradecido por este momento", french: "Je suis reconnaissant pour ce moment", arabic: "أنا ممتن لهذه اللحظة", dutch: "Ik ben dankbaar voor dit moment", time: 126 },
            { finnish: "Luonto ympärilläni on kaunista", english: "Nature around me is beautiful", spanish: "La naturaleza a mi alrededor es hermosa", french: "La nature autour de moi est belle", arabic: "الطبيعة من حولي جميلة", dutch: "Natuur om me heen is mooi", time: 132 },
            { finnish: "Sydämeni on täynnä lämpöä", english: "My heart is full of warmth", spanish: "Mi corazón está lleno de calidez", french: "Mon cœur est plein de chaleur", arabic: "قلبي مليء بالدفء", dutch: "Mijn hart is vol warmte", time: 138 },
            { finnish: "Tämä on minun kesäyöni", english: "This is my summer night", spanish: "Esta es mi noche de verano", french: "C'est ma nuit d'été", arabic: "هذه ليلة صيفي", dutch: "Dit is mijn zomernacht", time: 144 },
            { finnish: "Rakastan tätä aikaa vuodesta", english: "I love this time of year", spanish: "Amo esta época del año", french: "J'aime cette période de l'année", arabic: "أحب هذا الوقت من السنة", dutch: "Ik hou van deze tijd van het jaar", time: 150 },
            { finnish: "Kuu valaisee matkani", english: "Moon lights my way", spanish: "La luna ilumina mi camino", french: "La lune éclaire mon chemin", arabic: "القمر ينير طريقي", dutch: "Maan verlicht mijn weg", time: 156 },
            { finnish: "Linnut laulavat iltahämärässä", english: "Birds sing in the twilight", spanish: "Los pájaros cantan en el crepúsculo", french: "Les oiseaux chantent au crépuscule", arabic: "الطيور تغني في الشفق", dutch: "Vogels zingen in de schemering", time: 162 },
            { finnish: "Ilma on lämmin ja pehmeä", english: "Air is warm and soft", spanish: "El aire es cálido y suave", french: "L'air est chaud et doux", arabic: "الهواء دافئ وناعم", dutch: "Lucht is warm en zacht", time: 168 },
            { finnish: "Kesä on täällä taas", english: "Summer is here again", spanish: "El verano está aquí de nuevo", french: "L'été est de retour", arabic: "الصيف هنا مرة أخرى", dutch: "Zomer is er weer", time: 174 },
            { finnish: "Tämä on ihanaa aikaa", english: "This is wonderful time", spanish: "Este es un tiempo maravilloso", french: "C'est un moment merveilleux", arabic: "هذا وقت رائع", dutch: "Dit is een heerlijke tijd", time: 180 },
            { finnish: "Haluan että yö jatkuu", english: "I want the night to continue", spanish: "Quiero que la noche continúe", french: "Je veux que la nuit continue", arabic: "أريد أن يستمر الليل", dutch: "Ik wil dat de nacht doorgaat", time: 186 },
            { finnish: "Kesäyö on kaunis lahja", english: "Summer night is a beautiful gift", spanish: "La noche de verano es un regalo hermoso", french: "La nuit d'été est un beau cadeau", arabic: "ليلة الصيف هدية جميلة", dutch: "Zomernacht is een mooi geschenk", time: 192 },
            { finnish: "Säilytän sen muistois sani", english: "I keep it in my memories", spanish: "Lo guardo en mis recuerdos", french: "Je le garde dans mes souvenirs", arabic: "أحفظها في ذكرياتي", dutch: "Ik bewaar het in mijn herinneringen", time: 198 },
            { finnish: "Ikuisesti sydämessäni", english: "Forever in my heart", spanish: "Para siempre en mi corazón", french: "Pour toujours dans mon cœur", arabic: "إلى الأبد في قلبي", dutch: "Voor altijd in mijn hart", time: 204 }
        ]
    },
    {
        id: 2,

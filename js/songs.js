...
const songsDatabase = [
    ...
    },
    {
        ...
        lyrics: [
            { finnish: "Satumaa satumaa kaunehin paikka", english: "Fairyland fairyland most beautiful place", spanish: "Tierra de cuento tierra de cuento lugar más hermoso", french: "Pays des contes pays des contes plus bel endroit", arabic: "أرض الخيال أرض الخيال أجمل مكان", dutch: "Sprookjesland sprookjesland mooiste plek", time: 0 },
            { finnish: "Sinne haluan matkustaa", english: "There I want to travel", spanish: "Allí quiero viajar", french: "J'aimerais y voyager", arabic: "أريد السفر إلى هناك", dutch: "Daar wil ik naartoe reizen", time: 6 },
            { finnish: "Yli sinisen meren purjehtia", english: "Sail over the blue sea", spanish: "Navegar sobre el mar azul", french: "Naviguer sur la mer bleue", arabic: "أبحر فوق البحر الأزرق", dutch: "Zeilen over de blauwe zee", time: 12 },
            { finnish: "Veneellä kohti aurinkoa", english: "By boat towards the sun", spanish: "En barco hacia el sol", french: "En bateau vers le soleil", arabic: "بالقارب نحو الشمس", dutch: "Met een boot naar de zon", time: 18 },
            { finnish: "Missä kaikki on kaunista", english: "Where everything is beautiful", spanish: "Donde todo es hermoso", french: "Où tout est beau", arabic: "حيث كل شيء جميل", dutch: "Waar alles mooi is", time: 24 },
            { finnish: "Ihmiset ovat onnellisia", english: "People are happy", spanish: "La gente es feliz", french: "Les gens sont heureux", arabic: "الناس سعداء", dutch: "Mensen zijn gelukkig", time: 30 },
            { finnish: "Kukat kukkivat joka puolella", english: "Flowers bloom everywhere", spanish: "Las flores florecen por todas partes", french: "Les fleurs fleurissent partout", arabic: "الزهور تتفتح في كل مكان", dutch: "Bloemen bloeien overal", time: 36 },
            { finnish: "Linnut laulavat iloisia lauluja", english: "Birds sing happy songs", spanish: "Los pájaros cantan canciones alegres", french: "Les oiseaux chantent joyeusement", arabic: "الطيور تغني أغاني سعيدة", dutch: "Vogels zingen vrolijke liedjes", time: 42 },
            { finnish: "Haaveilen siitä joka päivä", english: "I dream of it every day", spanish: "Sueño con ello cada día", french: "J'en rêve chaque jour", arabic: "أحلم به كل يوم", dutch: "Ik droom ervan elke dag", time: 48 },
            { finnish: "Unessa käyn siellä usein", english: "In dreams I go there often", spanish: "En sueños voy allí a menudo", french: "En rêve j'y vais souvent", arabic: "في الأحلام أذهب هناك كثيراً", dutch: "In dromen ga ik er vaak heen", time: 54 },
            { finnish: "Jonain päivänä pääsen sinne", english: "Someday I will get there", spanish: "Algún día llegaré allí", french: "Un jour j'y arriverai", arabic: "يوماً ما سأصل هناك", dutch: "Op een dag kom ik daar", time: 60 },
            { finnish: "Matka ei ole liian pitkä", english: "The journey is not too long", spanish: "El viaje no es demasiado largo", french: "Le voyage n'est pas trop long", arabic: "الرحلة ليست طويلة جداً", dutch: "De reis is niet te lang", time: 66 },
            { finnish: "Kun sydän on täynnä toivoa", english: "When the heart is full of hope", spanish: "Cuando el corazón está lleno de esperanza", french: "Quand le cœur est plein d'espoir", arabic: "عندما القلب مليء بالأمل", dutch: "Wanneer het hart vol hoop is", time: 72 },
            { finnish: "Satumaa odottaa minua", english: "Fairyland waits for me", spanish: "Tierra de cuento me espera", french: "Le pays des contes m'attend", arabic: "أرض الخيال تنتظرني", dutch: "Sprookjesland wacht op mij", time: 78 },
            { finnish: "Auringon paisteessa lämpimässä", english: "In the warm sunshine", spanish: "Bajo el cálido sol", french: "Au soleil chaud", arabic: "في ضوء الشمس الدافئ", dutch: "In de warme zonneschijn", time: 84 },
            { finnish: "Tulen sinne pian asumaan", english: "I will come there soon to live", spanish: "Vendré allí pronto a vivir", french: "J'y viendrai bientôt vivre", arabic: "سآتي هناك قريباً للعيش", dutch: "Ik kom er binnenkort wonen", time: 90 },
            { finnish: "Tähtien alla kauniissa talossa", english: "Under the stars in a beautiful house", spanish: "Bajo las estrellas en una casa hermosa", french: "Sous les étoiles dans une belle maison", arabic: "تحت النجوم في منزل جميل", dutch: "Onder de sterren in een mooi huis", time: 96 },
            { finnish: "Kukkasten keskellä elämään", english: "To live among flowers", spanish: "Para vivir entre flores", french: "Pour vivre parmi les fleurs", arabic: "للعيش بين الزهور", dutch: "Om tussen de bloemen te leven", time: 102 },
            { finnish: "Se on minun unelmani koti", english: "It is my dream home", spanish: "Es mi hogar soñado", french: "C'est ma maison de rêve", arabic: "إنه بيت أحلامي", dutch: "Het is mijn droomhuis", time: 108 },
            { finnish: "Missä kaikki on täydellistä", english: "Where everything is perfect", spanish: "Donde todo es perfecto", french: "Où tout est parfait", arabic: "حيث كل شيء مثالي", dutch: "Waar alles perfect is", time: 114 },
            { finnish: "Täydellinen paikka minulle", english: "A perfect place for me", spanish: "Un lugar perfecto para mí", french: "Un endroit parfait pour moi", arabic: "مكان مثالي لي", dutch: "Een perfecte plek voor mij", time: 120 },
            { finnish: "Vihdoin voin olla onnellinen", english: "Finally I can be happy", spanish: "Finalmente puedo ser feliz", french: "Enfin je peux être heureux", arabic: "أخيراً يمكنني أن أكون سعيداً", dutch: "Eindelijk kan ik gelukkig zijn", time: 126 },
            { finnish: "Odotan innolla sitä päivää", english: "I eagerly await that day", spanish: "Espero con ansias ese día", french: "J'attends ce jour avec impatience", arabic: "أنتظر ذلك اليوم بفارغ الصبر", dutch: "Ik wacht verlangend op die dag", time: 132 },
            { finnish: "Kun voin lähteä matkalle", english: "When I can set off on a journey", spanish: "Cuando pueda partir de viaje", french: "Quand je pourrai partir en voyage", arabic: "عندما يمكنني الانطلاق في رحلة", dutch: "Wanneer ik op reis kan gaan", time: 138 },
            { finnish: "Satumaa on kaunein paikka", english: "Fairyland is the most beautiful place", spanish: "Tierra de cuento es el lugar más hermoso", french: "Le pays des contes est le plus bel endroit", arabic: "أرض الخيال أجمل مكان", dutch: "Sprookjesland is de mooiste plek", time: 144 },
            { finnish: "Haluan jakaa sen muiden kanssa", english: "I want to share it with others", spanish: "Quiero compartirlo con otros", french: "Je veux le partager avec d'autres", arabic: "أريد مشاركته مع الآخرين", dutch: "Ik wil het met anderen delen", time: 150 },
            { finnish: "Kun vihdoin pääsen sinne", english: "When I finally get there", spanish: "Cuando finalmente llegue allí", french: "Quand j'y arriverai enfin", arabic: "عندما أصل هناك أخيراً", dutch: "Wanneer ik er eindelijk kom", time: 156 },
            { finnish: "Tiedän että olen kotona", english: "I know I am home", spanish: "Sé que estoy en casa", french: "Je sais que je suis chez moi", arabic: "أعرف أنني في بيتي", dutch: "Weet ik dat ik thuis ben", time: 162 },
            { finnish: "Satumaa on missä kuulun", english: "Fairyland is where I belong", spanish: "Tierra de cuento es donde pertenezco", french: "Le pays des contes est là où j'appartiens", arabic: "أرض الخيال حيث أنتمي", dutch: "Sprookjesland is waar ik thuishoor", time: 168 },
            { finnish: "Minne sydämeni vetää", english: "Where my heart pulls me", spanish: "Donde mi corazón me atrae", french: "Où mon cœur m'attire", arabic: "حيث يجذبني قلبي", dutch: "Waar mijn hart me trekt", time: 174 },
            { finnish: "Tämä on minun unelmani", english: "This is my dream", spanish: "Este es mi sueño", french: "C'est mon rêve", arabic: "هذا حلمي", dutch: "Dit is mijn droom", time: 180 },
            { finnish: "Toivon että se toteutuu", english: "I hope it will come true", spanish: "Espero que se haga realidad", french: "J'espère qu'il se réalisera", arabic: "آمل أن يتحقق", dutch: "Ik hoop dat het uitkomt", time: 186 },
            { finnish: "Satumaa odottaa minua", english: "Fairyland waits for me", spanish: "Tierra de cuento me espera", french: "Le pays des contes m'attend", arabic: "أرض الخيال تنتظرني", dutch: "Sprookjesland wacht op mij", time: 192 },
            { finnish: "Minä tulen sinne pian", english: "I will come there soon", spanish: "Vendré allí pronto", french: "J'y viendrai bientôt", arabic: "سآتي هناك قريباً", dutch: "Ik kom er binnenkort", time: 198 },
            { finnish: "Sydän täynnä rakkautta", english: "Heart full of love", spanish: "Corazón lleno de amor", french: "Cœur plein d'amour", arabic: "قلب مليء بالحب", dutch: "Hart vol liefde", time: 204 }
        ]
    },
    {
        id: 3,
